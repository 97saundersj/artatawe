...
public class Testicles {
	...
	public static void main(String[] args) {
		...
		test.addProfile("Dick", "John", "JohnDick", "07333333333", "a bush", "SA14LN", null);
		...
		test2.addPainting("Fuck me", "Nothing here", "C:/Users/cyale/Desktop/Cs 135/DATABASE1.png", test.searchProfile("JohnDick"), 2019, 9, 3, 5, 5);
		test2.addPainting("Fuck me part 2", "Nothing here", "C:/Users/cyale/Desktop/Cs 135/DATABASE1.png", test.searchProfile("JohnDick2"), 2019, 0, 1, 5, 5);
        ...
        test2.getAllArtworks().get(0).addImageToArrayList("C:/Users/cyale/Desktop/Cs 135/DATABASE1.png");
        test4.save();
        System.out.println(Database.convertArrayListToImage(test4.manageArtwork().getAllArtworks().get(0).getAllPhotos()));
        /*test4.load();
        test4.loadImage("");
